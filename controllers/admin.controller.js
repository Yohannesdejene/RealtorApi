...
const { HOUSE_IMAGES_ARE_REQUIRED_ERR } = require('../middlewares/errors.middleware');


exports.createHouse = async (req, res, next) => {

    const {
        price, description, houseType, areaSize, city, subcity,
        addressName, mapLocation, bedrooms, bathrooms,
        floorNumber, agentName, agentNumber, secondAgentNumber,
        marketStatus, isActive, furnishingStatus
    } = req.body;
